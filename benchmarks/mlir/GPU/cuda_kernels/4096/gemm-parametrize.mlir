...
module attributes {gpu.container_module} {
  ...
  gpu.module @entry_kernel {
    ...
    gpu.func @entry_kernel(%arg0: memref<4096x4096xf32>, %arg1: memref<4096x4096xf32>, %arg2: memref<4096x4096xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 16, 16, 1>, gpu.known_grid_size = array<i32: 2, 2, 1>} {
      ...
      %gDimX = arith.constant 64 : index
      %gDimY = arith.constant 64 : index
      ...
      %subview = memref.subview %arg0[%4, 0] [64, 4096] [1, 1] : memref<4096x4096xf32> to memref<64x4096xf32, strided<[4096, 1], offset: ?>>
      %subview_0 = memref.subview %arg1[0, %5] [4096, 64] [1, 1] : memref<4096x4096xf32> to memref<4096x64xf32, strided<[4096, 1], offset: ?>>
      %subview_1 = memref.subview %arg2[%4, %5] [64, 64] [1, 1] : memref<4096x4096xf32> to memref<64x64xf32, strided<[4096, 1], offset: ?>>
      ...
      %BM = memref.dim %subview, %c0 : memref<64x4096xf32, strided<[4096, 1], offset: ?>>
      %BN = memref.dim %subview_0, %c1 : memref<4096x64xf32, strided<[4096, 1], offset: ?>>
      ...
      %dimK = memref.dim %subview, %c1 : memref<64x4096xf32, strided<[4096, 1], offset: ?>>
      ...
      scf.for %tm = %c0 to %TM step %c1 {
        scf.for %tn = %c0 to %TN step %c1 {
          ...
          %elemC = memref.load %subview_1[%cRow, %cCol] : memref<64x64xf32, strided<[4096, 1], offset: ?>>
      ...
      scf.for %subtileIv = %c0 to %numSubTilesK step %c1 {
        ...
        scf.for %subtileStep = %c0 to %numStepsA step %c1 {
          ...
          %elemA = memref.load %subview[%rowA, %colA] : memref<64x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        scf.for %subtileStep = %c0 to %numStepsB step %c1 {
          ...
          %elemB = memref.load %subview_0[%rowB, %tColB] : memref<4096x64xf32, strided<[4096, 1], offset: ?>>
      ...
      scf.for %tm = %c0 to %TM step %c1 {
        scf.for %tn = %c0 to %TN step %c1 {
          ...
          memref.store %res, %subview_1[%cRow, %cCol] : memref<64x64xf32, strided<[4096, 1], offset: ?>>
        }
      }
