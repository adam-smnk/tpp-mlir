...
module attributes {gpu.container_module} {
  ...
  gpu.module @entry_kernel {
    ...
    gpu.func @entry_kernel(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 32, 32, 1>} {
      ...
      %elemA = memref.load %subview[%2, %3] : memref<32x1024xf32, strided<[1024, 1], offset: ?>>
      %elemB = memref.load %subview_0[%2, %3] : memref<1024x32xf32, strided<[1024, 1], offset: ?>>
      ...
      %partRes = scf.for %subtileIv = %c0 to %ub step %c1 iter_args(%acc = %elemC) -> (f32) {
        ...
        %cp1 = nvgpu.device_async_copy %subview[%2, %offsetA], %smemA[%bufferTile, %2, %3], 1
                : memref<32x1024xf32, strided<[1024, 1], offset: ?>> to memref<2x32x32xf32, 3>
        %cp2 = nvgpu.device_async_copy %subview_0[%offsetB, %3], %smemB[%bufferTile, %2, %3], 1
              : memref<1024x32xf32, strided<[1024, 1], offset: ?>> to memref<2x32x32xf32, 3>
