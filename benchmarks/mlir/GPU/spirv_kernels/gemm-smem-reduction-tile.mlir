...
module attributes {gpu.container_module} {
  ...
  gpu.module @entry_kernel {
    gpu.func @entry_kernel(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 32, 32, 1>} {
      ...
      %smemA = memref.alloc() : memref<32x32xf32, #spirv.storage_class<Workgroup>>
      %smemB = memref.alloc() : memref<32x32xf32, #spirv.storage_class<Workgroup>>
      ...
      %res = scf.for %subtileIv = %c0 to %numSubTilesK step %c1 iter_args(%acc = %elemC) -> (f32) {
        ...
        memref.store %elemA, %smemA[%2, %3] : memref<32x32xf32, #spirv.storage_class<Workgroup>>
        memref.store %elemB, %smemB[%2, %3] : memref<32x32xf32, #spirv.storage_class<Workgroup>>
        ...
        %7 = scf.for %arg6 = %c0 to %c32 step %c1 iter_args(%arg7 = %acc) -> (f32) {
          ...
          %8 = memref.load %smemA[%2, %arg6] : memref<32x32xf32, #spirv.storage_class<Workgroup>>
          %9 = memref.load %smemB[%arg6, %3] : memref<32x32xf32, #spirv.storage_class<Workgroup>>
