...
// Default simple GEMM GPU kernel.
...
module attributes {gpu.container_module} {
  ...
  gpu.module @entry_kernel {
    gpu.func @entry_kernel(%arg0: memref<4096x4096xf32>, %arg1: memref<4096x4096xf32>, %arg2: memref<4096x4096xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 32, 32, 1>} {
      ...
      %6 = memref.load %subview_1[%2, %3] : memref<32x32xf32, strided<[4096, 1], offset: ?>>
      %7 = scf.for %arg6 = %arg3 to %arg4 step %arg5 iter_args(%arg7 = %6) -> (f32) {
        %8 = memref.load %subview[%2, %arg6] : memref<32x4096xf32, strided<[4096, 1], offset: ?>>
        %9 = memref.load %subview_0[%arg6, %3] : memref<4096x32xf32, strided<[4096, 1], offset: ?>>
        %10 = arith.mulf %8, %9 : f32
        %11 = arith.addf %arg7, %10 : f32
        scf.yield %11 : f32
      }
      memref.store %7, %subview_1[%2, %3] : memref<32x32xf32, strided<[4096, 1], offset: ?>>
      gpu.return
    }
  }
}
