...
module attributes {gpu.container_module} {
  ...
  gpu.module @entry_kernel {
    gpu.func @entry_kernel(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 8, 8, 1>, gpu.known_grid_size = array<i32: 32, 32, 1>} {
      ...
      %smemA = memref.alloc() : memref<32x4xf32, #spirv.storage_class<Workgroup>>
      %smemB = memref.alloc() : memref<4x32xf32, #spirv.storage_class<Workgroup>>
      ...
      scf.for %subtileIv = %c0 to %numSubTilesK step %c1 {
        ...
        scf.for %subtileStep = %c0 to %numStepsB step %c1 {
          ...
          memref.store %elemB, %smemB[%smemRowB, %tColB] : memref<4x32xf32, #spirv.storage_class<Workgroup>>
        }
        ...
        scf.for %offset = %c0 to %BK step %c1 {
          scf.for %tm = %c0 to %TM step %c1 {
            ...
            %elemA = memref.load %smemA[%smemRowA, %offset] : memref<32x4xf32, #spirv.storage_class<Workgroup>>
          ...
          scf.for %tn = %c0 to %TN step %c1 {
            ...
            %elemB = memref.load %smemB[%offset, %smemColB] : memref<4x32xf32, #spirv.storage_class<Workgroup>>
