...
module attributes {gpu.container_module} {
  func.func @entry(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>) -> memref<1024x1024xf32> {
    ...
    gpu.launch_func  @entry_kernel::@entry_kernel blocks in (%c128, %c128, %c1) threads in (%c8, %c8, %c1)  args(%arg0 : memref<1024x1024xf32>, %arg1 : memref<1024x1024xf32>, %arg2 : memref<1024x1024xf32>, %c0 : index, %c1024 : index, %c1 : index)
  ...
  gpu.module @entry_kernel {
    gpu.func @entry_kernel(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 32, 32, 1>} {
      ...
      %subview = memref.subview %arg0[%4, 0] [8, 1024] [1, 1] : memref<1024x1024xf32> to memref<8x1024xf32, strided<[1024, 1], offset: ?>>
      %subview_0 = memref.subview %arg1[0, %5] [1024, 8] [1, 1] : memref<1024x1024xf32> to memref<1024x8xf32, strided<[1024, 1], offset: ?>>
      %subview_1 = memref.subview %arg2[%4, %5] [8, 8] [1, 1] : memref<1024x1024xf32> to memref<8x8xf32, strided<[1024, 1], offset: ?>>
      %6 = memref.load %subview_1[%2, %3] : memref<8x8xf32, strided<[1024, 1], offset: ?>>
      %7 = scf.for %arg6 = %arg3 to %arg4 step %arg5 iter_args(%arg7 = %6) -> (f32) {
        ...
        %8 = memref.load %subview[%2, %arg6] : memref<8x1024xf32, strided<[1024, 1], offset: ?>>
        %9 = memref.load %subview_0[%arg6, %3] : memref<1024x8xf32, strided<[1024, 1], offset: ?>>
        %10 = arith.mulf %8, %9 : f32
        %11 = arith.addf %arg7, %10 : f32
        scf.yield %11 : f32
      }
      // C tile consecutive elements -> coalesced [fast]
      memref.store %7, %subview_1[%2, %3] : memref<8x8xf32, strided<[1024, 1], offset: ?>>
      gpu.return
    }
  }
}
